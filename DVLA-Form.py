...
driver.find_element_by_name("input_1").send_keys("Rakesh")
#Address line 1
driver.find_element_by_name("input_10").send_keys(" The Blenheim Centre")
#ADDRESS LINE 2
driver.find_element_by_name("input_43").send_keys("Prince Regent Road")
# Town
...
#POSTCODE
driver.find_element_by_name("input_5").send_keys("TW31ND")
#tickbox
time.sleep(5)
